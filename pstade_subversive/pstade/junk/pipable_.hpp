...
namespace pstade {
    ...
    namespace pipable_detail {
        ...
        template< class A, class Function, class Arguments > inline
        typename result_of_piping<A const, Function, Arguments>::type
        ...
        private nonassignable
    {
        ...
        struct apply
        {
            typedef pipe< Function,
                boost::tuples::tuple< PSTADE_PP_ENUM_PTR_PARAMS(PSTADE_EGG_MAX_ARITY, A) >
            > type;
        };
    ...
    #undef  PSTADE_max_arity
        ...
        explicit pipe() // DefaultConstructible iif 'Function' is.
        { }
    ...
    private:
        ...
        Arguments m_args; // tuple of pointers for DefaultConstructible.

    }; // struct pipe


    #define PSTADE_PIPABLE(Object, Function) \
        PSTADE_SINGLETON_CONST( pstade::pipe< Function >, Object ) \
    /**/
...
{
    typedef pipe< Function,
        boost::tuples::tuple< PSTADE_PP_ENUM_PTR_PARAMS(n, A) >
    > type;
};
