...
#include <boost/egg/detail/as_mpl_lambda.hpp>
...
#include <boost/egg/pstade/oven.hpp>
...
typedef BOOST_EGG_DEFER((counting_from_detail::base<boost::mpl::_>)) T_counting_from;
...
typedef pstade::egg::result_of_ambi0<
    ::base_op_front<BOOST_EGG_AS_MPL_LAMBDA((pstade::oven::range_value<boost::mpl::_>))>
