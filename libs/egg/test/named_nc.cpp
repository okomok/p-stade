...
T_named_foo1 const named_foo1 = BOOST_EGG_NAMED_L {} BOOST_EGG_NAMED_R;


PSTADE_POD_CONSTANT((pstade::egg::keyword<0>), _in) = BOOST_EGG_KEYWORD;
PSTADE_POD_CONSTANT((pstade::egg::keyword<1>), _out) = BOOST_EGG_KEYWORD;
