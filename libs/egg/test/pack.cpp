...
BOOST_MPL_ASSERT(( boost::is_same< boost::tuples::tuple<>,
                 pstade::result_of<pstade::egg::T_pack()>::type > ));

BOOST_MPL_ASSERT(( boost::is_same< boost::tuples::tuple<int&, int const&>,
                 pstade::result_of<pstade::egg::T_pack(int&, int)>::type > ));
...
BOOST_MPL_ASSERT(( boost::is_same< boost::tuples::tuple<>,
                 pstade::result_of<pstade::egg::X_pack<pstade::egg::by_ref>()>::type > ));

BOOST_MPL_ASSERT(( boost::is_same< boost::tuples::tuple<int&, int const&>,
                 pstade::result_of<pstade::egg::X_pack<pstade::egg::by_ref>(int&, int const&)>::type > ));
