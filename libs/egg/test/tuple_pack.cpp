...
void test_ref()
{
    ...
    BOOST_CHECK( boost::make_tuple(i0,i1,i2,i3,i4,i5,i6,i7,i8,i9) == tuple_pack_by_ref(i0,i1,i2,i3,i4,i5,i6,i7,i8,i9) );
    ...
    BOOST_CHECK( &(boost::tuples::get<9>(tuple_pack_by_ref(i0,i1,i2,i3,i4,i5,i6,i7,i8,i9))) == &i9 );
}
