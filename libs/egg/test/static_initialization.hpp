#ifndef BOOST_LIBS_EGG_STATIC_INITIALIZATION_HPP
#define BOOST_LIBS_EGG_STATIC_INITIALIZATION_HPP
...
typedef boost::egg::static_<boost::egg::X_construct<int> >::type T_construct_int;
