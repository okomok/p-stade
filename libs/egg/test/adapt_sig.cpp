...
adapted_equal const adapted_equal_fun = PSTADE_EGG_ADAPT_SIG_RESULT_INITIALIZER(BOOST_PP_IDENTITY({}));
...
adapted_nullary const adapted_nullary_fun = PSTADE_EGG_ADAPT_SIG_RESULT_INITIALIZER(BOOST_PP_IDENTITY({}));
