#include <boost/egg/pstade/detect_result_type.hpp>
...
T_curried_plus const curried_plus
    =
BOOST_EGG_CURRY2_L BOOST_EGG_AMBI({}) BOOST_EGG_CURRY2_R /*< A macro invocation must be sandwiched using `_L` and `_R`. >*/
    ;
...
result_of_pipable<base_mult>::type const mult = BOOST_EGG_PIPABLE({});
