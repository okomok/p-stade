...
#include <pstade/fat/tuple_size.hpp>
...
void pstade_minimal_test()
{
    ...
    BOOST_CHECK( fat::tuple_size<pair_t>::value == 2);
    BOOST_CHECK( fat::tuple_size<tup_t>::value == 2);
    BOOST_CHECK( fat::tuple_size<boost::tuples::null_type>::value == 0 );
}
