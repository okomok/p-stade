...
namespace graphics {
    ...
    {
        return graphics_draw(x, pstade::detail::overload<>());
    }
...
//
template< class ShapeT >
test_code graphics_draw(ShapeT& x, pstade::detail::overload<>)
{
...
inline test_code graphics_draw(Line&, pstade::detail::overload<>)
{
    return Line_value;
}

inline test_code graphics_draw(const Line&, pstade::detail::overload<>)
{
...
namespace crop { namespace mystery { // is not required for pstade::detail::overload<>.

    inline test_code graphics_draw(crop::mystery::Circle&, pstade::detail::overload<>)
    {
        return Circle_value;
    }
    inline test_code graphics_draw(const crop::mystery::Circle&, pstade::detail::overload<>)
    {
...
template< class CharT >
test_code graphics_draw(never_open::Text<CharT>&, pstade::detail::overload<>)
{
    return Text_value;
}
...
template< class CharT >
test_code graphics_draw(const never_open::Text<CharT>&, pstade::detail::overload<>)
{
...
// built-in type test
//
inline test_code graphics_draw(float&, pstade::detail::overload<>)
{
    return float_value;
}

inline test_code graphics_draw(const float&, pstade::detail::overload<>)
{
