...
#ifndef BOOST_EGG_DETAIL_SUPPRESS_WARNING_BEGIN_INCLUDE_HPP
#define BOOST_EGG_DETAIL_SUPPRESS_WARNING_BEGIN_INCLUDE_HPP
#include <boost/config.hpp>
    ...
    #pragma inline_depth(255) // max inline depth
        ...
        #define BOOST_EGG_SCL_SECURE_NO_DEPRECATE
    #endif

    #if !defined(_CRT_SECURE_NO_DEPRECATE)
        #define _CRT_SECURE_NO_DEPRECATE
        #define BOOST_EGG_CRT_SECURE_NO_DEPRECATE
    #endif
