...
void egg_test()
{
...

    {
        ...
        BOOST_CHECK(details::replace(1)(i1, i2, i3, i4, i5) == 1);
        BOOST_CHECK(details::replace(X_arg<2>())(i1, i2, i3, i4, i5) == 2);
        BOOST_CHECK(details::replace(placeholders::_2)(i1, i2, i3, i4, i5) == 2);
    }
}
