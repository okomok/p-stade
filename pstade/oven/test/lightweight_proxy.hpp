#ifndef PSTADE_OVEN_TEST_LIGHTWEIGHT_PROXY_HPP
#define PSTADE_OVEN_TEST_LIGHTWEIGHT_PROXY_HPP
...
void lightweight_proxy(Range const& rng)
{
...
template< class Range > inline
void non_lightweight_proxy(Range const& rng)
{
    BOOST_CHECK(!test::is_lightweight_proxy(BOOST_FOREACH_IS_LIGHTWEIGHT_PROXY(rng)));
}
