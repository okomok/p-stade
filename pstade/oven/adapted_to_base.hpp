...
PSTADE_POD_CONSTANT((op_to_base), to_base) = PSTADE_EGG_AUXILIARY_L PSTADE_EGG_AUTOMATIC_TYPE PSTADE_EGG_AUXILIARY_R;
...
PSTADE_POD_CONSTANT((op_to_base_range), to_base_range) = PSTADE_EGG_AUXILIARY_L PSTADE_EGG_AUTOMATIC_TYPE PSTADE_EGG_AUXILIARY_R;
