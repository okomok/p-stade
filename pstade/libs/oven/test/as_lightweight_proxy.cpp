...
struct a_range :
    ...
    , private pstade::oven::as_lightweight_proxy< a_range<T> >
{ };
...
struct a_range_lightweight : a_range<T>
    , private pstade::oven::as_lightweight_proxy< a_range_lightweight<T> >
{ };
...
namespace tempo {
    ...
    struct b_range :
        boost::iterator_range<T *>
        , private pstade::oven::as_lightweight_proxy< b_range<T> >
    { };
