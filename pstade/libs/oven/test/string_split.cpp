...
#include <pstade/oven/literal.hpp>
...
void test()
{
...

    {
        ...
        BOOST_FOREACH (
            ...
            src|string_split( boost::algorithm::first_finder("-*-"|as_literal, boost::algorithm::is_iequal()) )
        ) {
        ...
        oven::for_each(
            src|string_split( boost::first_finder("-*-"|as_literal, boost::is_iequal()) ),
            ::fun(out)
        );
