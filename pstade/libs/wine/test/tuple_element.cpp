...
namespace pair_test {
    ...
    BOOST_MPL_ASSERT((boost::is_same<int, tuple_element_c<seq_t, 0>::type>));
    BOOST_MPL_ASSERT((boost::is_same<double, tuple_element_c<seq_t, 1>::type>));

    BOOST_MPL_ASSERT((boost::is_same<int, tuple_element_c<seq_t const, 0>::type>));
    BOOST_MPL_ASSERT((boost::is_same<double, tuple_element_c<seq_t const, 1>::type>));
