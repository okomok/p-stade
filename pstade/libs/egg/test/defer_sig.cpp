...
typedef result_of_defer_nullary_sig< ::nullary_sig >::type adapted_nullary;
adapted_nullary const adapted_nullary_fun = PSTADE_EGG_DEFER_SIG_L {} PSTADE_EGG_DEFER_SIG_R;
