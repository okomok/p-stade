...
#include <pstade/egg/callable_facade.hpp>
...
struct op_foo :
    pstade::egg::callable_facade<op_foo, char>
{
...
struct op_bar :
    pstade::egg::callable_facade< op_bar<T0, T1>, char >
{
    template< class Myself, class A0, class A1 = void >
    struct apply
    {
...
struct error_msg_check :
    pstade::egg::callable_facade<error_msg_check>
{
    template< class Myself, class A0 >
    struct apply
    {
...
struct my_identity :
    pstade::egg::callable_facade<my_identity>
{
    template< class Myself, class A0 >
    struct apply
    {
