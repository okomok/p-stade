...
BOOST_MPL_ASSERT((boost::is_same< pstade::egg::unref_by_perfect<int&>::type, int >));
BOOST_MPL_ASSERT((boost::is_same< pstade::egg::unref_by_perfect<int const&>::type, int const >));
BOOST_MPL_ASSERT((boost::is_same< pstade::egg::unref_by_perfect<int>::type, int const >));
BOOST_MPL_ASSERT((boost::is_same< pstade::egg::unref_by_perfect<int const>::type, int const >));
