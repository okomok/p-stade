...
#include <pstade/egg/tuple/prepend.hpp>
...
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int&, tup_t>, pstade::result_of<X_tuple_prepend<by_ref>(tup_t&, int&)>::type>));
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int const&, tup_t>, pstade::result_of<X_tuple_prepend<by_ref>(tup_t&, int const&)>::type>));
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int const&, tup_t>, pstade::result_of<X_tuple_prepend<by_ref>(tup_t&, int const)>::type>));

BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int const&, tup_t>, pstade::result_of<X_tuple_prepend<by_cref>(tup_t&, int&)>::type>));
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int const&, tup_t>, pstade::result_of<X_tuple_prepend<by_cref>(tup_t&, int const&)>::type>));
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int const&, tup_t>, pstade::result_of<X_tuple_prepend<by_cref>(tup_t&, int)>::type>));

BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int, tup_t>, pstade::result_of<X_tuple_prepend<by_value>(tup_t&, int&)>::type>));
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int, tup_t>, pstade::result_of<X_tuple_prepend<by_value>(tup_t&, int const&)>::type>));
BOOST_MPL_ASSERT((boost::is_same<boost::tuples::cons<int, tup_t>, pstade::result_of<X_tuple_prepend<by_value>(tup_t&, int)>::type>));
#endif
