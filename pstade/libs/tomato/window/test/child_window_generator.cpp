...
#include <pstade/tomato/window/child_window_generator.hpp>
...
void test()
{
    ...
    tomato::child_window_generator wnds(::GetDesktopWindow());
...
// vexing parse! :-(
    ( tomato::child_window_generator(::GetDesktopWindow()) ) 
        (::output);
}
