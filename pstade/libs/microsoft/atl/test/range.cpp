...
#include <boost/microsoft/atl/range.hpp> // can be placed first
#include <boost/microsoft/atl/pointee.hpp>
...
#include <boost/microsoft/atl/config.hpp> // BOOST_MICROSOFT_ATL_VER
#include <boost/microsoft/atl/coll.hpp>
#include <boost/microsoft/atl/simpcoll.hpp>
#include <boost/microsoft/atl/simpstr.hpp>
#include <boost/microsoft/atl/str.hpp>
#include <boost/microsoft/atl/cstringt.hpp>
...
make_indirect_range(Range& rng)
{
    return boost::make_iterator_range(
        boost::make_indirect_iterator(boost::begin(rng)),
        boost::make_indirect_iterator(boost::end(rng))
    );
}
...
void collection()
{
...

    {
        ...
        test::random_access(test::make_indirect_range(rng), ans);
    }
...

    {
        ...
        test::bidirectional(test::make_indirect_range(rng));
    }
