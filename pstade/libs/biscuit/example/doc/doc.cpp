...
void test_valseq()
{
    ...
    PSTADE_CHECK(( biscuit::match< valseq< value_at<2>, value_at<0> > >(inputs, values) ));
}
...
void test_valset()
{
    ...
    PSTADE_CHECK(( biscuit::match< valset< value_at<0>, value_at<1>, value_at<2> > >(inputs0, values) ));
    PSTADE_CHECK(( biscuit::match< valset< value_at<0>, value_at<1>, value_at<2> > >(inputs1, values) ));
    PSTADE_CHECK(( biscuit::match< valset< value_at<0>, value_at<1>, value_at<2> > >(inputs2, values) ));
}
