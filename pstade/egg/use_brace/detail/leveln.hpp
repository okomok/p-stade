#ifndef PSTADE_EGG_USE_BRACE_DETAIL_LEVELN_HPP
#define PSTADE_EGG_USE_BRACE_DETAIL_LEVELN_HPP
...
#define PSTADE_EGG_USE_BRACE_LEVELN() <pstade/egg/use_brace/detail/leveln_include.hpp>
