...
namespace pstade { namespace egg {
    ...
    namespace pipable_detail {
        ...
        {
            Function m_function;
            ArgTuple m_arg_tuple;

            typedef ArgTuple arg_tuple_type;
        ...
        operator|(A& a, function< pipable<Function, ArgTuple> > const& pi)
        {
            return fuse(pi.m_baby.m_function)(here::push_front(pi.m_baby.m_arg_tuple, a));
        }

        template<class A, class Function, class ArgTuple> inline
        typename result_of_output<PSTADE_DEDUCED_CONST(A), Function, ArgTuple>::type
        operator|(A const& a, function< pipable<Function, ArgTuple> > const& pi)
        {
            return fuse(pi.m_baby.m_function)(here::push_front(pi.m_baby.m_arg_tuple, a));
        }
...
#define n BOOST_PP_ITERATION()
    ...
    struct apply<Myself, BOOST_PP_ENUM_PARAMS(n, A)>
    {
        typedef
            function<
                pipable< Function, boost::tuples::tuple<PSTADE_PP_ENUM_PARAMS_WITH(n, A, &)> >
            >
        type;
    };
    ...
    Result call(BOOST_PP_ENUM_BINARY_PARAMS(n, A, & a)) const
    {
        ...
        Result r = { { m_function, typename baby_t::arg_tuple_type(BOOST_PP_ENUM_PARAMS(n, a)) } };
        return r;
    }
