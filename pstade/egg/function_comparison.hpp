...
#ifndef PSTADE_EGG_FUNCTION_COMPARISON_HPP
#define PSTADE_EGG_FUNCTION_COMPARISON_HPP
...
#define PSTADE_ops (6, (==, !=, <, >, <=, >=))
    #define  BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC(BOOST_PP_ARRAY_SIZE(PSTADE_ops)), <pstade/egg/function_comparison.hpp>))
