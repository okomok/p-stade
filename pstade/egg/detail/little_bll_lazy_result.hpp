...
#ifndef PSTADE_EGG_DETAIL_LITTLE_BLL_LAZY_RESULT_HPP
#define PSTADE_EGG_DETAIL_LITTLE_BLL_LAZY_RESULT_HPP
#include "./prefix.hpp"
...
namespace pstade { namespace egg { namespace detail {
    ...
    // 0ary
        typedef typename
            result_of<T_bll_bind(Base const&)>::type
        nullary_result_type;
    ...
    // 1ary-
        ...
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_BLL_BIND_TARGET_MAX_ARITY, <pstade/egg/detail/little_bll_lazy_result.hpp>))
...
#define n BOOST_PP_ITERATION()
    ...
    struct apply<Myself, BOOST_PP_ENUM_PARAMS(n, A)> :
        result_of<
            T_bll_bind(Base const&, PSTADE_PP_ENUM_PARAMS_WITH(n, A, &))
        >
    { };
