...
#ifndef PSTADE_EGG_DETAIL_BABY_ADAPT_HPP
#define PSTADE_EGG_DETAIL_BABY_ADAPT_HPP
#include "./prefix.hpp"
...
namespace pstade { namespace egg { namespace detail {
    ...
    #define PSTADE_typedef_arg(Z, N, _) typedef BOOST_PP_CAT(A, N) BOOST_PP_CAT(arg, N);
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_MAX_ARITY, <pstade/egg/detail/baby_adapt.hpp>))
