...
// 5 or more arity is not recommended; it tends to make so many functions.
...
#if !defined(PSTADE_SPECIFIED_PARAMS)


    #ifndef PSTADE_SPECIFIED_HEADER_PART
    #define PSTADE_SPECIFIED_HEADER_PART
    ...
    #define PSTADE_SPECIFIED0(Name, Op, SeqOrNum) \
        PSTADE_SPECIFIED0_aux(Name, Op, PSTADE_PP_TO_TEMPLATE_PARAM_SEQ(SeqOrNum)) \
    /**/

        #define PSTADE_SPECIFIED0_aux(Name, Op, Seq) \
    ...
    #define PSTADE_SPECIFIED1(Name, Op, SeqOrNum) \
        PSTADE_SPECIFIED1_aux(Name, Op, PSTADE_PP_TO_TEMPLATE_PARAM_SEQ(SeqOrNum)) \
    /**/

        #define PSTADE_SPECIFIED1_aux(Name, Op, Seq) \
    ...
    #endif // PSTADE_SPECIFIED_HEADER_PART


#else // !defined(PSTADE_SPECIFIED_PARAMS)


    #define PSTADE_arities BOOST_PP_TUPLE_ELEM(4, 0, PSTADE_SPECIFIED_PARAMS)
    #define PSTADE_name    BOOST_PP_TUPLE_ELEM(4, 1, PSTADE_SPECIFIED_PARAMS)
    #define PSTADE_op      BOOST_PP_TUPLE_ELEM(4, 2, PSTADE_SPECIFIED_PARAMS)
    #define PSTADE_params  PSTADE_PP_TO_TEMPLATE_PARAM_SEQ(BOOST_PP_TUPLE_ELEM(4, 3, PSTADE_SPECIFIED_PARAMS))
    ...
    #define PSTADE_function_aux(ArgTypes, Params, N) \
        ...
        PSTADE_DETAIL_RESULT_OF( (PSTADE_op<PSTADE_PP_TO_TEMPLATE_ARGS(PSTADE_params, X)>), ArgTypes ) \
    ...
    #undef  PSTADE_SPECIFIED_PARAMS


#endif // !defined(PSTADE_SPECIFIED_PARAMS)
