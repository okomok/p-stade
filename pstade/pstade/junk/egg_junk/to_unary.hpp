...
#ifndef PSTADE_EGG_DETAIL_TO_UNARY_HPP
#define PSTADE_EGG_DETAIL_TO_UNARY_HPP
#include "./prefix.hpp"
...
#include "./baby_to_unary_result.hpp"
...
namespace pstade { namespace egg { namespace detail {
    ...
    #define PSTADE_unwrap(Z, N, _) , detail::unwrap_ref(BOOST_PP_CAT(a, N))
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_MAX_ARITY, <pstade/egg/detail/to_unary.hpp>))
    ...
    typedef function<baby_to_unary> op_to_unary;
    PSTADE_POD_CONSTANT((op_to_unary), to_unary) = {{}};
...
#define n BOOST_PP_ITERATION()
    ...
    struct apply<Myself, Base, BOOST_PP_ENUM_PARAMS(n, A)>
    {
        typedef
            function<
                PSTADE_PP_CAT3(baby_to_unary, n, _result)<
