#ifndef PSTADE_UNIQUE_PTR_HPP
#define PSTADE_UNIQUE_PTR_HPP
...
// What:
//
// Also known as 'move_ptr', which makes both
// 'boost::scoped_ptr' and 'std::auto_ptr' derepcated.
// This is from <boost/interprocess/smart_ptr/unique_ptr_emulation.hpp>
// or http://home.twcny.rr.com/hinnant/cpp_extensions/unique_ptr_03.html
...
using boost_ext::unique_ptr;
using boost_ext::move;
