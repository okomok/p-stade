...
make_token_range(ForwardRange& r, UserState& us, typename const_overloaded<ForwardRange>::type = 0)
{
...
make_token_range(ForwardRange& r, typename const_overloaded<ForwardRange>::type = 0)
{
