...
namespace with_line_number_detail {
    ...
    struct baby
    {
        ...
        result_type operator()(Range& rng, int n = 0, val_t nl = detail::default_newline<val_t>::value()) const
        {
...
PSTADE_FUNCTION(make_with_line_number, (with_line_number_detail::baby<_>))
...
PSTADE_CONSTANT(line_number, (op_line_number))
