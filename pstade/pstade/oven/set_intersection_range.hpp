...
struct op_make_set_intersection_range :
    callable<op_make_set_intersection_range>
{
...
PSTADE_SINGLETON_CONST(make_set_intersection_range, op_make_set_intersection_range)
