...
#ifndef PSTADE_OVEN_RANGE_BASED1_HPP
#define PSTADE_OVEN_RANGE_BASED1_HPP
...
namespace range_based1_detail {
        ...
        callable< return_op<IterBased> >
    {
        ...
        struct apply<Myself, Range0> :
            boost::result_of<
                PSTADE_CONSTABLE_TPL(IterBased const)(
    ...
    #define PSTADE_max_arity BOOST_PP_DEC(PSTADE_CALLABLE_MAX_ARITY)
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_max_arity, <pstade/oven/range_based1.hpp>))
...
PSTADE_OBJECT_GENERATOR(range_based1, (range_based1_detail::return_op< deduce<_1, as_value> >))
