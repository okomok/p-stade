...
// What:
//
// Makes an iterator to be DefaultConstructible and CopyAssignable.
...
private:
    // This could be 'share_ptr' if SinglePassTraversal,
    // but this iterator is now used only in 'memoized',
    // which is the ForwardRange.
