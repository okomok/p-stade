...
namespace shared_single_detail {
    ...
    typedef egg::function<little_new_array1, egg::by_value> new_array1;
...
typedef egg::function<shared_single_detail::little, egg::by_value> T_shared_single;
