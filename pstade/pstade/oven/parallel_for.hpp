#ifndef PSTADE_OVEN_PARALLEL_FOR_HPP
#define PSTADE_OVEN_PARALLEL_FOR_HPP
...
typedef egg::function<parallel_for_detail::baby> op_parallel_for;
PSTADE_POD_CONSTANT((op_parallel_for), parallel_for) = {{}};
