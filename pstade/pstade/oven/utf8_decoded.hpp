...
namespace utf8_decoded_detail {
    ...
    private:
        ...
        {
            m_value = static_cast<U32Type>(static_cast<boost::uint8_t>(*this->base()));
            // we must not have a continuation character:
            if ((m_value & 0xC0u) == 0x80u)
                invalid_sequnce();
            // see how many extra byts we have:
            unsigned extra = boost::detail::utf8_trailing_byte_count(*this->base());
    ...
    friend class boost::iterator_core_access;
        ...
        void increment()
        {
            ...
            unsigned c = boost::detail::utf8_byte_count(*this->base());
        ...
        void decrement()
        {
            ...
            unsigned count = 0;
            while ((*--this->base_reference() & 0xC0u) == 0x80u) ++count;
            // now check that the sequence was valid:
            if (count != boost::detail::utf8_trailing_byte_count(*this->base()))
                invalid_sequnce();
            m_value = pending_read;
        }
    };
    ...
    callable< op_make_utf8_decoded<U32Type> >
{
    ...
    {
        typedef
            utf8_decoded_detail::u8_to_u32_iterator<
