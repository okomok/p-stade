    ...
    private as_lightweight_proxy< set_symmetric_difference_range<Range1, Range2, Compare> >
{
    ...
    typedef set_symmetric_difference_range type;

private:
    typedef typename set_symmetric_difference_range_detail::super_<Range1, Range2, Compare>::type super_t;

public:
    set_symmetric_difference_range(Range1& rng1, Range2& rng2, Compare const& comp = less) :
...
PSTADE_OBJECT_GENERATOR(make_set_symmetric_difference_range,
    (set_symmetric_difference_range< deduce<_1, to_qualified>, deduce<_2, to_qualified>, deduce<_3, to_value, op_less> >) const)
