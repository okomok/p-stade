...
namespace pstade_oven_extension {
    ...
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CAutoPtrArray), 1)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CInterfaceArray), (class)(const IID *))

    // lists
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CAtlList), 2)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CAutoPtrList), 1)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CHeapPtrList), 2)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CInterfaceList), (class)(const IID *))

    // maps
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CAtlMap), 4)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CRBTree), 4)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CRBMap), 4)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CRBMultiMap), 4)

    // strings
    #if !defined(BOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
        PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CSimpleStringT), (class)(bool))
    #else
        PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CSimpleStringT), 1)
    #endif
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CStringT), 2)
...
#else
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CSimpleArray), 1)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CSimpleMap), 2)
    PSTADE_OVEN_EXTENSION_OF_TEMPLATE((ATL)(CSimpleValArray), 1)
#endif
