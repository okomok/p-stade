#ifndef PSTADE_OVEN_DETAIL_ALGO_FORMS_HPP
#define PSTADE_OVEN_DETAIL_ALGO_FORMS_HPP
...
#define PSTADE_OVEN_DETAIL_ALGO_FORM(SizeSeq, Xxx, ResultFun) \
    \
    ...
    { \
        ...
        { }; \
        \
        BOOST_PP_SEQ_FOR_EACH(PSTADE_OVEN_DETAIL_ALGO_FORM_call, Xxx, SizeSeq) \
    }; \
    \
...
/**/
    ...
    #define PSTADE_OVEN_DETAIL_ALGO_FORM_call(R, Xxx, Size) \
...
#define PSTADE_OVEN_DETAIL_ALGO_FORM_BINARY(SizeSeq, Xxx, ResultFun) \
   \
    struct BOOST_PP_CAT(op_, Xxx) : \
        ::pstade::callable<BOOST_PP_CAT(op_, Xxx)> \
    { \
        ...
        { }; \
        \
        BOOST_PP_SEQ_FOR_EACH(PSTADE_OVEN_DETAIL_ALGO_FORM_BINARY_call, Xxx, SizeSeq) \
    }; \
    \
    PSTADE_CONSTANT( Xxx, (BOOST_PP_CAT(op_, Xxx)) ) \
    \
/**/
    ...
    #define PSTADE_OVEN_DETAIL_ALGO_FORM_BINARY_call(R, Xxx, Size) \
        ...
        { \
            return ::std::Xxx(::boost::begin(rng1), ::boost::end(rng1), ::boost::begin(rng2), ::boost::end(rng2) \
                BOOST_PP_COMMA_IF(Size) BOOST_PP_ENUM_PARAMS(Size, a) ); \
        } \
    /**/
