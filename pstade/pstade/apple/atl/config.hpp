...
#include <atldef.h> // _ATL_VER
    ...
    #define PSTADE_APPLE_ATL_VER _ATL_VER
    ...
    #if (_ATL_VER < 0x0700)
        #define PSTADE_APPLE_ATL_NO_COLLECTIONS
    #endif
#endif
        ...
        #define PSTADE_APPLE_ATL_HAS_OLD_CSIMPLECOLL
    #endif
#endif
    ...
    #define PSTADE_APPLE_ATL_CSIMPLEMAP_TEMPLATE_PARAMS   class TKey, class TVal, class TEqual
    #define PSTADE_APPLE_ATL_CSIMPLEMAP_TEMPLATE_ARGS     TKey, TVal, TEqual
#else
    #define PSTADE_APPLE_ATL_CSIMPLEARRAY_TEMPLATE_PARAMS class T
    #define PSTADE_APPLE_ATL_CSIMPLEARRAY_TEMPLATE_ARGS   T
    #define PSTADE_APPLE_ATL_CSIMPLEMAP_TEMPLATE_PARAMS   class TKey, class TVal
    #define PSTADE_APPLE_ATL_CSIMPLEMAP_TEMPLATE_ARGS     TKey, TVal
#endif
