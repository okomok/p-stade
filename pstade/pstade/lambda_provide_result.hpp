...
#include <pstade/preprocessor.hpp>
    ...
    #define PSTADE_LAMBDA_PROVIDE_RESULT_MAX_ARITY 9 // follows 'tuple'.
#endif
...
#define PSTADE_LAMBDA_PROVIDE_NULLARY_RESULT_OF_TYPE(NameSeq) \
    PSTADE_LAMBDA_PROVIDE_NULLARY_RESULT_OF_TYPE_aux(PSTADE_PP_FULLNAME(NameSeq)) \
/**/

    #define PSTADE_LAMBDA_PROVIDE_NULLARY_RESULT_OF_TYPE_aux(Fullname) \
        namespace boost { \
            \
            template< > \
...
#define PSTADE_LAMBDA_PROVIDE_NULLARY_RESULT_OF_TEMPLATE(NameSeq, ParamSeqOrCount) \
    PSTADE_LAMBDA_PROVIDE_NULLARY_RESULT_OF_TEMPLATE_aux(PSTADE_PP_FULLNAME(NameSeq), PSTADE_PP_TO_TEMPLATE_PARAM_SEQ(ParamSeqOrCount)) \
/**/

    #define PSTADE_LAMBDA_PROVIDE_NULLARY_RESULT_OF_TEMPLATE_aux(Fullname, ParamSeq) \
        namespace boost { \
            \
