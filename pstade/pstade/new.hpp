...
// 2ary -
//
#define PSTADE_NEW_call_operator(R, BitSeq) \
...
#define PSTADE_NEW_arg_type(R, _, Index, Bit) \
    BOOST_PP_COMMA_IF(Index) BOOST_PP_CAT(PSTADE_NEW_ac, Bit)(BOOST_PP_CAT(A, Index)) \
/**/

#define PSTADE_NEW_param(R, _, Index, Bit) \
    BOOST_PP_COMMA_IF(Index) \
    BOOST_PP_CAT(A, Index) BOOST_PP_CAT(PSTADE_NEW_c, Bit) & BOOST_PP_CAT(a, Index) \
/**/
...
#undef PSTADE_NEW_arg_type
#undef PSTADE_NEW_call_operator
