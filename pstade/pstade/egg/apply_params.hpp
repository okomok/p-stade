...
#define PSTADE_EGG_FLAT_APPLY_PARAMS(A) \
    class BOOST_PP_CAT(A, 0) BOOST_PP_REPEAT_FROM_TO(1, BOOST_PP_INC(PSTADE_EGG_FLAT_MAX_ARITY), PSTADE_EGG_APPLY_PARAMS_op, A) \
/**/
