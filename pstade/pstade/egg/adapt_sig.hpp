...
#ifndef PSTADE_EGG_ADAPT_SIG_HPP
#define PSTADE_EGG_ADAPT_SIG_HPP
...
#include "./sig_template.hpp"
    ...
    #define PSTADE_EGG_ADAPT_SIG_MAX_ARITY 6
#endif
...
namespace pstade { namespace egg {
    ...
    struct adapt_sig_error_non_nullary;


    namespace adapt_sig_detail {
        ...
        // 0ary
            ...
            typedef typename
                boost::mpl::eval_if< IsNullary,
                    result0,
                    boost::mpl::identity< adapt_sig_error_non_nullary<SigFun> >
                >::type
        ...
        // 1ary-
            ...
            #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_ADAPT_SIG_MAX_ARITY, <pstade/egg/adapt_sig.hpp>))
    ...
    template<class SigFun>
    struct result_of_adapt_sig
    {
        typedef
            adapt_sig_detail::result_<SigFun, boost::mpl::false_>
        type;
    };

    #define PSTADE_EGG_ADAPT_SIG_RESULT_INITIALIZER(B) \
        { B() } \
    /**/

    typedef
        generator<
            result_of_adapt_sig< deduce<boost::mpl::_1, as_value> >::type,
            use_brace_level0
        >::type
    op_adapt_sig;
    ...
    template<class SigFun>
    struct result_of_adapt_nullary_sig
    {
        typedef
            adapt_sig_detail::result_<SigFun, boost::mpl::true_>
        type;
    };

    typedef
        generator<
            result_of_adapt_nullary_sig< deduce<boost::mpl::_1, as_value> >::type,
            use_brace_level0
        >::type
...
PSTADE_EGG_NULLARY_RESULT_OF_TEMPLATE(pstade::egg::adapt_sig_detail::result_, (class)(class))
