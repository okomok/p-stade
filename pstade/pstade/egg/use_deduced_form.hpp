...
namespace pstade { namespace egg {
    ...
    namespace detail {
        ...
        struct call_baby<use_deduced_form, Result>
        {
        // 0ary
            template<class Baby>
        ...
        // 1ary-
            #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_MAX_LINEAR_ARITY, <pstade/egg/use_deduced_form.hpp>))
