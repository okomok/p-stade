...
#ifndef PSTADE_EGG_BABY_GENERATOR_HPP
#define PSTADE_EGG_BABY_GENERATOR_HPP
...
namespace pstade { namespace egg { namespace baby {
    ...
    // 0ary
     ...
     // 1ary-
        ...
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_MAX_ARITY, <pstade/egg/baby/generator.hpp>))
