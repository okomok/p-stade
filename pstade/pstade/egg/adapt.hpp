...
namespace pstade { namespace egg {
    ...
    #define PSTADE_typedef_arg(Z, N, _) typedef BOOST_PP_CAT(A, N) BOOST_PP_CAT(arg, N);
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, PSTADE_EGG_MAX_ARITY, <pstade/egg/adapt.hpp>))
    ...
    #define PSTADE_EGG_ADAPT(O, L) \
        namespace BOOST_PP_CAT(pstade_egg_adapt_workarea_of_, O) { \
            ...
            typedef pstade::egg::function< pstade::egg::adapt<PSTADE_EGG_DETAIL_AS_MPL_LAMBDA(L)> > op; \
        } \
