#ifndef PSTADE_FAT_AUTO_OBJECT_HPP
#define PSTADE_FAT_AUTO_OBJECT_HPP
...
namespace pstade { namespace fat {
    ...
    namespace auto_object_detail {
        ...
        // 'egg::automatic' doesn't work; 'auto_ptr' is not CopyConstructible.
        ...
        struct automator
        {
            ...
            {
                std::auto_ptr<X> ptr(egg::fuse(xp_new_<X>())(m_args));
                m_any = ptr;
        ...
        typedef egg::function<baby_fused> fused;
    ...
    typedef
        egg::result_of_unfuse<
            auto_object_detail::fused,
            boost::use_default,
            egg::use_nullary_result
        >::type
    op_auto_object;
