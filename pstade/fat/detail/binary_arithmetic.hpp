#ifndef PSTADE_FAT_DETAIL_BINARY_ARITHMETIC_HPP
#define PSTADE_FAT_DETAIL_BINARY_ARITHMETIC_HPP
#include "./prefix.hpp"
...
namespace pstade { namespace fat { namespace detail {
...
#define PSTADE_FAT_BINARY_ARITHMETIC(F, Op) \
    template<class X, class Y> \
    ...
    \
    typedef egg::function<BOOST_PP_CAT(baby_, F)> BOOST_PP_CAT(op_, F); \
    PSTADE_EGG_OBJECT((BOOST_PP_CAT(op_, F)), F) = { {} }; \
/**/


} } } // namespace pstade::fat::detail
