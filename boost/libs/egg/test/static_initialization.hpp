...
typedef
    ...
    >::type
T_my_func;
PSTADE_POD_CONSTANT((T_my_func), my_func) = BOOST_EGG_UNCURRY_L BOOST_EGG_CURRY4_L {{999}} BOOST_EGG_CURRY4_R BOOST_EGG_UNCURRY_R;
...
PSTADE_POD_CONSTANT((T_pipa), pipa) = BOOST_EGG_PIPABLE_L {999} BOOST_EGG_PIPABLE_R;
T_pipa const &get_pipa1();
T_pipa const &get_pipa2();

typedef pstade::egg::result_of_ambi1<T_my_plus>::type T_auxi;
PSTADE_POD_CONSTANT((T_auxi), auxi) = BOOST_EGG_AMBI_L {999} BOOST_EGG_AMBI_R;
T_auxi const &get_auxi1();
T_auxi const &get_auxi2();


typedef pstade::egg::static_<pstade::egg::X_construct<int> >::type T_construct_int;
T_construct_int const construct_int = BOOST_EGG_STATIC(pstade::egg::X_construct<int> );
