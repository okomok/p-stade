...
typedef BOOST_EGG_DEFER((little<boost::mpl::_>)) T_identity;
PSTADE_POD_CONSTANT((T_identity), identity) = BOOST_EGG_DEFERRED();

typedef BOOST_EGG_DEFER_BY((little<boost::mpl::_>), boost::use_default) T_identity_;
PSTADE_POD_CONSTANT((T_identity_), identity_) = BOOST_EGG_DEFERRED();
