...
#ifndef BOOST_EGG_DETAIL_LITTLE_DEFERRED_HPP
#define BOOST_EGG_DETAIL_LITTLE_DEFERRED_HPP
#include "./prefix.hpp"
...
namespace pstade { namespace egg { namespace detail {
    ...
    #define PSTADE_typedef_arg(Z, N, _) typedef BOOST_PP_CAT(A, N) BOOST_PP_CAT(arg, N);
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <boost/egg/detail/little_deferred.hpp>))
