#ifndef BOOST_EGG_DETAIL_VC7_1_ARRAY_RESURRECT_HPP
#define BOOST_EGG_DETAIL_VC7_1_ARRAY_RESURRECT_HPP
#include "./prefix.hpp"
...
// See also <boost/egg/pstade/deduced_const.hpp>, which is easier workaround.
