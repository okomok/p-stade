...
#if !defined(BOOST_EGG_VC7_1_RESULT_OF_MAX_ARITY)
    #define BOOST_EGG_VC7_1_RESULT_OF_MAX_ARITY 5
#endif
...
// 2ary-
    ...
    #define PSTADE_ac1(A) const_ref<A>
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (2, BOOST_EGG_VC7_1_RESULT_OF_MAX_ARITY, <boost/egg/detail/vc7_1_result_of.hpp>))
