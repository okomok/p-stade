...
#endif
#define PSTADE_name    BOOST_PP_TUPLE_ELEM(4, 0, BOOST_EGG_SPECIFIED_PARAMS)
#define PSTADE_op      BOOST_PP_TUPLE_ELEM(4, 1, BOOST_EGG_SPECIFIED_PARAMS)
#define PSTADE_params  PSTADE_PP_TO_TEMPLATE_PARAM_SEQ(BOOST_PP_TUPLE_ELEM(4, 2, BOOST_EGG_SPECIFIED_PARAMS))
#define PSTADE_arities BOOST_PP_SEQ_TO_ARRAY(BOOST_PP_TUPLE_ELEM(4, 3, BOOST_EGG_SPECIFIED_PARAMS))
    ...
    #define PSTADE_function_aux(ArgTypes, Params, N) \
        ...
        BOOST_EGG_RESULT_OF_IN_NS_SCOPE( (PSTADE_op<PSTADE_PP_SEQ_ENUM_ARGS(PSTADE_params, X)>), ArgTypes ) \
    ...
    #define PSTADE_ac1(A) BOOST_EGG_CONST_REF(A)
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC(BOOST_PP_ARRAY_SIZE(PSTADE_arities)), <boost/egg/detail/specified_include.hpp>))
