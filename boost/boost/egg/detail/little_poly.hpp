...
#ifndef BOOST_EGG_DETAIL_LITTLE_POLY_HPP
#define BOOST_EGG_DETAIL_LITTLE_POLY_HPP
...
namespace boost { namespace egg { namespace details {
    ...
    // 1ary-
        ...
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <boost/egg/detail/little_poly.hpp>))
...
#define n BOOST_PP_ITERATION()
    ...
    {
        typedef typename
            mpl::BOOST_PP_CAT(apply, n)<Expr, BOOST_PP_ENUM_PARAMS(n, A)>::type
        impl_t;
