#ifndef BOOST_EGG_COMPOSE2_HPP
#define BOOST_EGG_COMPOSE2_HPP
...
namespace pstade { namespace egg {
    ...
    // BOOST_EGG_UNFUSE_L { { F, G1, G2 } } BOOST_EGG_UNFUSE_M BOOST_EGG_UNFUSE_DEFAULT_PACK BOOST_EGG_UNFUSE_R
    #define BOOST_EGG_COMPOSE2_L  BOOST_EGG_UNFUSE_L { {
    #define BOOST_EGG_COMPOSE2_M1 ,
    #define BOOST_EGG_COMPOSE2_M2 ,
    #define BOOST_EGG_COMPOSE2_R  } } BOOST_EGG_UNFUSE_M BOOST_EGG_UNFUSE_DEFAULT_PACK BOOST_EGG_UNFUSE_R
    #define BOOST_EGG_COMPOSE2(F, G1, G2) BOOST_EGG_COMPOSE2_L F BOOST_EGG_COMPOSE2_M1 G1 BOOST_EGG_COMPOSE2_M2 G2 BOOST_EGG_COMPOSE2_R
    ...
    namespace compose2_detail {
        ...
        struct little
        {
            ...
            {
                Result r = BOOST_EGG_COMPOSE2(f, g, h);
                return r;
            }
        };
