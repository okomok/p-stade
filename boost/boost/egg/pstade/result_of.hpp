...
// If you are lost, include <boost/egg/pstade/detect_result_type.hpp> before any boost header.
...
namespace pstade {
    ...
    // 1ary-
    #define  BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_RESULT_OF_NUM_ARGS, <boost/egg/pstade/result_of.hpp>))
