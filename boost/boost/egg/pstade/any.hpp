...
#include <boost/egg/pstade/as_type_erasure.hpp>
#include <boost/egg/pstade/disable_if_copy.hpp>
#include <boost/egg/do_swap.hpp>
#include <boost/egg/static_downcast.hpp>
#include <boost/egg/pstade/nonvirtual.hpp>
...
#include <boost/egg/pstade/type_equal_to.hpp>
#include "./any_fwd.hpp"
