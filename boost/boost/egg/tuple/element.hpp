#ifndef BOOST_EGG_TUPLE_ELEMENT_HPP
#define BOOST_EGG_TUPLE_ELEMENT_HPP
...
#include <boost/egg/pstade/apple/is_boost_tuple.hpp>
#include <boost/egg/pstade/apple/pair_fwd.hpp>
#include "./config.hpp"
