#ifndef BOOST_EGG_FROM_HPP
#define BOOST_EGG_FROM_HPP
...
#include <boost/egg/pstade/apple/boost/any_fwd.hpp>
#include <boost/egg/pstade/pod_constant.hpp>
#include <boost/egg/pstade/poly_fwd.hpp>
...
namespace pstade { namespace egg {
    ...
    PSTADE_POD_CONSTANT((T_from_any), from_any) = BOOST_EGG_AUTOMATIC();
    ...
    PSTADE_POD_CONSTANT((T_from_boost_any), from_boost_any) = BOOST_EGG_AUTOMATIC();
    ...
    PSTADE_POD_CONSTANT((T_from_poly), from_poly) = BOOST_EGG_AUTOMATIC();
