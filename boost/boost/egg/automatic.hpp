#ifndef BOOST_EGG_AUTOMATIC_HPP
#define BOOST_EGG_AUTOMATIC_HPP
...
namespace pstade { namespace egg {
    ...
    #define BOOST_EGG_AUTOMATIC() \
        BOOST_EGG_UNFUSE_L {{}} BOOST_EGG_UNFUSE_M BOOST_EGG_UNFUSE_DEFAULT_PACK BOOST_EGG_UNFUSE_R
    /**/

    #define BOOST_EGG_AUTOMATIC_REF BOOST_EGG_AUTOMATIC()
