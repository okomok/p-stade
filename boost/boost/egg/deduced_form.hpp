...
#ifndef BOOST_EGG_DEDUCED_FORM_HPP
#define BOOST_EGG_DEDUCED_FORM_HPP
...
namespace pstade { namespace egg {
    ...
    {
        #define  BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_EGG_MAX_LINEAR_ARITY, <boost/egg/deduced_form.hpp>))
